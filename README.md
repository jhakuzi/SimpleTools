...
- **XP/Gold** — session XP (rate, TTL, rested) and gold/hr in one tab, each with its own overlay. Rates refresh every 30 seconds so they do not flicker; the elapsed clock still ticks.
